...
<div class="containers container">
    <form action="/Users/login" method="POST" class="form d-flex container align-items-center justify-content-center flex-column gap-5">

        <div style="text-align:center;" class="my-4">
            <h2 style="font-style:normal; font-family:monospace; color:#262626"><span class="span">Con</span>nexion utilisateurs</h2>
        </div>

        <?php if (isset($_SESSION['error'])): ?>
            <p class="c-danger d-flex align-items-center justify-content-center flex-row" style="color:red">
                <?=$_SESSION['error']?>
            </p>
            <?php 
